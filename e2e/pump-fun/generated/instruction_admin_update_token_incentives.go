...
// AdminUpdateTokenIncentivesDiscriminator is the discriminator that prefixes the serialized data.
...
func (inst *AdminUpdateTokenIncentives) MarshalWithEncoder(encoder *ag_binary.Encoder) error {
	if err := encoder.WriteBytes(AdminUpdateTokenIncentivesDiscriminator, false); err != nil {
		return err
	}
	if err := encoder.Encode(inst.StartTime); err != nil {
		return err
	}
	if err := encoder.Encode(inst.EndTime); err != nil {
		return err
	}
	if err := encoder.Encode(inst.SecondsInADay); err != nil {
		return err
	}
	if err := encoder.Encode(inst.DayNumber); err != nil {
		return err
	}
	if err := encoder.Encode(inst.PumpTokenSupplyPerDay); err != nil {
		return err
	}
	return nil
}
...
func (inst *AdminUpdateTokenIncentives) UnmarshalWithDecoder(decoder *ag_binary.Decoder) error {
	if got, err := decoder.ReadNBytes(len(AdminUpdateTokenIncentivesDiscriminator)); err != nil {
		return err
	} else if !bytes.Equal(got, AdminUpdateTokenIncentivesDiscriminator) {
		return fmt.Errorf("invalid discriminator for AdminUpdateTokenIncentives: got %x, want %x", got, AdminUpdateTokenIncentivesDiscriminator)
	}
	if err := decoder.Decode(&inst.StartTime); err != nil {
		return err
	}
	if err := decoder.Decode(&inst.EndTime); err != nil {
		return err
	}
	if err := decoder.Decode(&inst.SecondsInADay); err != nil {
		return err
	}
	if err := decoder.Decode(&inst.DayNumber); err != nil {
		return err
	}
	if err := decoder.Decode(&inst.PumpTokenSupplyPerDay); err != nil {
		return err
	}
	return nil
}
