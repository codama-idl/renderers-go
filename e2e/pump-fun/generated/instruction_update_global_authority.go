...
// UpdateGlobalAuthorityDiscriminator is the discriminator that prefixes the serialized data.
...
func (inst *UpdateGlobalAuthority) MarshalWithEncoder(encoder *ag_binary.Encoder) error {
	if err := encoder.WriteBytes(UpdateGlobalAuthorityDiscriminator, false); err != nil {
		return err
	}
	return nil
}
...
func (inst *UpdateGlobalAuthority) UnmarshalWithDecoder(decoder *ag_binary.Decoder) error {
	if got, err := decoder.ReadNBytes(len(UpdateGlobalAuthorityDiscriminator)); err != nil {
		return err
	} else if !bytes.Equal(got, UpdateGlobalAuthorityDiscriminator) {
		return fmt.Errorf("invalid discriminator for UpdateGlobalAuthority: got %x, want %x", got, UpdateGlobalAuthorityDiscriminator)
	}
	return nil
}
